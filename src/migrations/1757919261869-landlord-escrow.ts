...
export class LandlordEscrow1757919261869 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "booking" ADD "landlordEscrowDepositDueAt" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "booking" ADD "landlordEscrowDepositFundedAt" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TYPE "public"."booking_status_enum" RENAME TO "booking_status_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."booking_status_enum" AS ENUM('PENDING_LANDLORD', 'REJECTED', 'PENDING_SIGNATURE', 'SIGNED', 'AWAITING_DEPOSIT', 'DEPOSIT_FUNDED', 'DUAL_ESCROW_FUNDED', 'AWAITING_FIRST_RENT', 'READY_FOR_HANDOVER', 'ACTIVE', 'SETTLEMENT_PENDING', 'SETTLED', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payment_purpose_enum" AS ENUM('WALLET_TOPUP', 'ESCROW_DEPOSIT', 'OWNER_ESCROW_DEPOSIT', 'FIRST_MONTH_RENT', 'MONTHLY_RENT')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_purpose_enum_old" AS ENUM('WALLET_TOPUP', 'ESCROW_DEPOSIT', 'FIRST_MONTH_RENT', 'MONTHLY_RENT')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."booking_status_enum_old" AS ENUM('PENDING_LANDLORD', 'REJECTED', 'PENDING_SIGNATURE', 'SIGNED', 'AWAITING_DEPOSIT', 'DEPOSIT_FUNDED', 'AWAITING_FIRST_RENT', 'READY_FOR_HANDOVER', 'ACTIVE', 'SETTLEMENT_PENDING', 'SETTLED', 'CANCELLED')`);
        await queryRunner.query(`ALTER TABLE "booking" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "booking" DROP COLUMN "landlordEscrowDepositFundedAt"`);
        await queryRunner.query(`ALTER TABLE "booking" DROP COLUMN "landlordEscrowDepositDueAt"`);
    }
