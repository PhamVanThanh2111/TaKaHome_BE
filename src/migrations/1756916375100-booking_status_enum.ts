...
export class BookingStatusEnum1756916375100 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."booking_status_enum" AS ENUM('PENDING_LANDLORD', 'REJECTED', 'PENDING_SIGNATURE', 'SIGNED', 'AWAITING_DEPOSIT', 'DEPOSIT_FUNDED', 'AWAITING_FIRST_RENT', 'READY_FOR_HANDOVER', 'ACTIVE', 'SETTLEMENT_PENDING', 'SETTLED', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."payment_method_enum" AS ENUM('WALLET', 'VNPAY')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_method_enum_old" AS ENUM('CASH', 'VNPAY')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."booking_status_enum_old" AS ENUM('ACTIVE', 'INACTIVE', 'PENDING', 'APPROVED', 'REJECTED', 'COMPLETED', 'CANCELLED')`);
        await queryRunner.query(`ALTER TABLE "booking" ALTER COLUMN "status" DROP DEFAULT`);
