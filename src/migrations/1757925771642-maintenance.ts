...
export class Maintenance1757925771642 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."maintenance_ticket_status_enum" AS ENUM('OPEN', 'RESOLVED', 'DISPUTED', 'CLOSED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "maintenance_ticket" ADD CONSTRAINT "FK_710cd2497ed0c4593d5dd0c134a" FOREIGN KEY ("bookingId") REFERENCES "booking"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "maintenance_ticket" DROP CONSTRAINT "FK_710cd2497ed0c4593d5dd0c134a"`,
    );
    await queryRunner.query(`DROP TABLE "maintenance_ticket"`);
    await queryRunner.query(
      `DROP TYPE "public"."maintenance_ticket_status_enum"`,
    );
  }
}
